...
import com.capstone.diary.member.service.MemberServiceImpl;
...
@Operation(summary = "내 정보 수정", description = "회원 인증 정보로 내 정보를 수정하는 API")
@ApiResponses(value = {
...
public @interface MemberUpdateApi {
}
